package personal.learning.consumer.group2;
...
@Component
public class ConsumerRoundRobinAssignor3 {
	
	@KafkaListener(id = "myListener6", topics = {"${test.topic.gamma}", "${test.topic.delta}"}, groupId = "${test.group.name2}", 
