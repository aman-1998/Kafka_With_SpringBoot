...
public class KafkaProducerConfig {
	...
	@Bean
	public NewTopic goodFeedbackTopic() {
		return new NewTopic(goodFeedbackTopic, 3, (short)1);
	}
	
	@Bean
	public NewTopic badFeedbackTopic() {
		return new NewTopic(badFeedbackTopic, 3, (short)1);
	}
