...
public class MessagePublisher {
	...
	public void sendMessageFeedback(Feedback message) {
		
		CompletableFuture<SendResult<String, Object>> future = kafkaTemplate.send(feedbackTopic, 
															   String.valueOf(message.getFeedbackId()), message);
