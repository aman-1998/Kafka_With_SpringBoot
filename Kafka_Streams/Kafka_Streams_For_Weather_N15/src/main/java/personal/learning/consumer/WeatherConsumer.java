...
public class WeatherConsumer {
	...
	@KafkaListener(id = "myListener1", topics = "${test.topic.weather}", groupId = "${test.group.weather}", 
		   	   autoStartup = "true", containerFactory = "kafkaListenerContainerFactory1")
	public void consume(Weather message, @Header(name = KafkaHeaders.RECEIVED_TOPIC, required = false) String topic, 
