...
public class KafkaProducerConfig {
	...
	public NewTopic humidityTopic() {
		return new NewTopic(humidityTopic, 3, (short)1);
	}
	
	@Bean
	public NewTopic precipitationTopic() {
		return new NewTopic(precipitationTopic, 3, (short)1);
	}
	
	@Bean
	public NewTopic weatherTopic() {
		return new NewTopic(weatherTopic, 3, (short)1);
	}
